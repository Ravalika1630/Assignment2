...
\begin{figure}[ht!]
\centering
\includegraphics[width=\columnwidth]{SAME-LINE.png}
\caption{SAME-LINES}
...
\end{align}
%
As left part is converted into identity matrix the intersection vector is \myvec{2\\3}

PLOT OF GIVEN LINES -
\numberwithin{figure}{section}
\begin{figure}[ht!]
\centering
\includegraphics[width=\columnwidth]{INTERSECTING-LINE.png}
